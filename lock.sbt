...
dependencyOverrides in ThisBuild ++= Set(
  ...
  "com.typesafe.akka" % "akka-cluster-tools_2.11" % "2.4.11",
  "com.typesafe.akka" % "akka-cluster_2.11" % "2.4.11",
  "com.typesafe.akka" % "akka-contrib_2.11" % "2.4.11",
  ...
  "org.coursera" % "metrics-datadog" % "1.1.4",
...
// LIBRARY_DEPENDENCIES_HASH 687f8412e86089ece333ac185d8a3010a30fff21
