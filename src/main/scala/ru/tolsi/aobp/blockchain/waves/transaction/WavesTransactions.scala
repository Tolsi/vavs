...
import ru.tolsi.aobp.blockchain.base.{BlockChainSignedTransaction, BlockChainTransaction, Signature64}
...
abstract sealed class WavesTransaction extends BlockChainTransaction[WavesBlockChain] {
