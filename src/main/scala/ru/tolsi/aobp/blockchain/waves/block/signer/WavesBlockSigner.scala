...
private[signer] class WavesBlockSigner(implicit signCreator: ArraySignCreator[WavesBlockChain#B]) extends WavesSigner[WavesBlockChain#B, SignedBlock[WavesBlockChain#B], Signature64] {
