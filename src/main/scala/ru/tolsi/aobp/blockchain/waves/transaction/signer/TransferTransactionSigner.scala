...
private[signer] class TransferTransactionSigner(implicit dataForSignCreator: DataForSignCreator[TransferTransaction]) extends WavesSigner[TransferTransaction, WavesSignedTransaction[TransferTransaction], Signature64] {
